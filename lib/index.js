...
const NODE_ENV = RAW_NODE_ENV ? process.env.NODE_ENV.toLowerCase() : 'development';
const RELEASE_ENV = RAW_RELEASE_ENV ? process.env.RELEASE_ENV.toLowerCase() : NODE_ENV;
...
const WAS_RUN_THRU_MOCHA = nonEmpty(RAW_LOADED_MOCHA_OPTS) || (!!RAW_mocha && toBool(RAW_mocha, false) !== false);
exports.env = {
    NODE_ENV,
    LOG_LEVEL,
    IE_COMPAT,
